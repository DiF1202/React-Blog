...
import { ScheduleOutlined, TagOutlined, UserOutlined, LinkOutlined } from '@ant-design/icons';
...
const ProductionItem = props => {
  ...
  return (
    <ProductionItemWrap ref={ProductionRef} className={['production', `battle${index}`].join(' ')} index={index} isShow={isShow} img={getPreviewImgUrl(item.img, { q: 80 })}>
